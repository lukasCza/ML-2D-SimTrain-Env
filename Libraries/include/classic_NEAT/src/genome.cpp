...
Genome::Genome(const Genome& genome)
{
	...
	NNode *inode = nullptr; //For forming a gene 
	NNode *onode = nullptr; //For forming a gene
	Trait *traitptr = nullptr;
...
Genome *Genome::duplicate(int new_id) 
{
	...
	NNode *newnode = nullptr;
	Gene *newgene = nullptr;
	Trait *assoc_trait = nullptr;  //Trait associated with current item
