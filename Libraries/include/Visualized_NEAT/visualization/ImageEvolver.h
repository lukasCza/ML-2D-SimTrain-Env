...
#include <Visualized_NEAT/neat/NetworkGenotype.h>
...
private:
	...
	float _bestFitness; // For most fit one in order to keep track of best across all generations
...
public:
	void train(const neat::NetworkGenotype &genotype, size_t populationSize, size_t numGenerations, std::mt19937 &generator);
